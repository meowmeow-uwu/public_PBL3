...
public abstract class CollectionService implements ServiceInterface<Collection> {
    private CollectionDAO collectionDAO = CollectionDAO.getInstance();
    private CollectionOfWordDAO collectionOfWordDAO = CollectionOfWordDAO.getInstance();
    private CollectionOfUserDAO collectionOfUserDAO = CollectionOfUserDAO.getInstance();
